        ...
        <div className="container mx-auto max-w-[1200px] px-6 md:px-12 lg:px-20">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              ...
              <p>
                There was no way we could do enough good works to earn salvation, but Jesus saved us because he loves us.  This act of undeserved salvation is what we call grace &ndash; a gift we don&apos;t deserve, but God grants it to us anyways.
              </p>
              <p>
