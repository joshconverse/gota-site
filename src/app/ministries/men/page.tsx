          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto">
                Building godly men through fellowship, accountability, and service. We gather for Bible study, prayer, and activities that strengthen brotherhood and spiritual growth.
              </p>
              <Link
                href="/ministries"
        ...
        <div className="container mx-auto max-w-[1200px] px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              We&apos;re currently building out this page. Check back soon for more details about our Men&apos;s Ministry programs, schedules, and how to get involved.
            </p>
          </div>
        </div>
      </section>
